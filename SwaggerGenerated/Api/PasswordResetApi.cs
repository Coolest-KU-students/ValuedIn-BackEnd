...
namespace IO.Swagger.Api
{
    ...
    {
        /// <summary>
        /// Reset password Reset the password for the user
        /// </summary>
        /// <returns></returns>
        void ResetPass ();
    }
    ...
    public class PasswordResetApi : IPasswordResetApi
    {
        ...
        public void ResetPass ()
        {
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException ((int)response.StatusCode, "Error calling ResetPass: " + response.Content, response.Content);
            else if (((int)response.StatusCode) == 0)
                throw new ApiException ((int)response.StatusCode, "Error calling ResetPass: " + response.ErrorMessage, response.ErrorMessage);
